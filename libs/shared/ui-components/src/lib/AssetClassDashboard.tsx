...
import { Account, Transaction, TransactionType, Valuation } from '@useful-apps/shared/types';
import {
                            ...
                            <ResponsiveContainer width="100%" height="100%">
                                <ComposedChart data={individualTrendData}>
                                    ...
                                    <Tooltip contentStyle={tooltipStyle} itemStyle={tooltipItemStyle} labelStyle={tooltipLabelStyle}
                                        formatter={(val: number, name: string) => [formatCurrency(val, displayCurrency), (name === 'marketValue' || name === 'Market Value') ? 'Market Value' : 'Cost Basis']}
                                    />
